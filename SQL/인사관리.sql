...
--1. 각 사원에 대해 다음 항목을 생성하는 질의를 작성하고 열 레이블을 Dream Salaries로 지정하시오. (변환함수, 연결연산자)
--<employee last_name> earns <salary> monthly but wants <salary 3배 >. 
...
-- 4. 사원의 이름과 커미션을 표시하는 질의를 작성하시오. 커미션을 받지 않는 사원일 경우 “No Commission”을 표시하시오. 열 레이블은 COMM으로 지정하시오. (nvl함수)
